...
pub fn get_env_vars() -> HashMap<&'static str, &'static str> {
    ...
    env_vars.insert("MONGO_URI", "lM7PEhFes5wh22i8O0wK2WW9smXRsQ/+hOjnQ7Xzs39spyAl1zHtdIM=");
    env_vars.insert("TOKEN_SECRET", "wMeWEEgJs5U7xD2ybExXiWn2/m/S5wr7ilNfY4jV+6I1YWVDB8BEpSLK688bO2LZwk3McMu+9WymMnIMm4j4mSqpnBLuXNEGHBbxOu5yBb4=");
    env_vars.insert("KEY", "aP9s87f6gR5h4j3k5l1G0n9b8v7c6xO2");
